    ...
    <div class="BTTRowStyle" role="presentation">
      ...
      <div class="BTTCellStyle" role="presentation" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="Bars_dojox_charting_widget_Chart2D08_copy" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot08_copy" store="new dojo.data.ObjectStore({objectStore:new com.ibm.btt.store.mapping.BTTMapping({store:dijit.byId('Bars_bttStoreWidget'),mappingOptions:{'value':{'x':'!INDEX','y':'amount'}},rootPath:'listFL'})})"></div>
        </div>
      </div>
      <div class="BTTCellStyle" role="presentation" align="left" style="vertical-align:middle;">
      </div>

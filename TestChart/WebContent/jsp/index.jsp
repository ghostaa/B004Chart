...
<body class="claro">
  ...
  <div role="presentation" id="index_panel" class="BTTTableStyle">
    <div class="BTTRowStyle" role="presentation">
      <div class="BTTCellStyle" role="presentation" align="left" style="vertical-align:top;">
        <bttdojo:form id="index_form" errorPage="index.jsp">
          <div role="presentation" style="width:353px;height:265px;" class="BTTTableStyle">
            <div class="BTTRowStyle" role="presentation">
            ...
            <div class="BTTRowStyle" role="presentation">
              <div class="BTTCellStyle" role="presentation" align="left" style="vertical-align:middle;">
                <bttdojo:a id="index_link" text="%nls.bttsample/Click_Link_Run_Flow" flowId="B004_main_Flow"/>
              </div>
            </div>
          </div>
      </bttdojo:form>
    ...
    <div class="BTTRowStyle" role="presentation">
      <div class="BTTCellStyle" role="presentation" align="left" style="vertical-align:middle;">
        <bttdojo:a id="index_link01" text="Link" action="jsp/B004Chart/Test.jsp"/>
      </div>
    </div>
  </div>
